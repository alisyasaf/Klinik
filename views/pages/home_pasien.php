...
<div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="btn nav-link" onclick="view_pasien()">
                <span>Profil</span></a>
            </li>
            ...
            <hr class="sidebar-divider my-0">
            <li class="nav-item active">
                <a class="btn nav-link" onclick="form_daftar()">
                <span>Buat Janji</span></a>
            <hr class="sidebar-divider my-0">
            <li class="nav-item active">
                <a class="btn nav-link" onclick="view_pasien()">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                    <div id="page" class="jumbotron pt-0 bg-light">
                        <h1 class="display-5">Hello, Pasien <b><?= $_SESSION['nama_lengkap'] ?></b></h1>
