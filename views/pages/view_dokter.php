                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-end">
                                ...
                                <div class="col-1">
                                    <a class="btn btn-primary" onkeyup="search_dokter()">Search</a><br/><br/>
                                </div>
                            </div>
                            <a class="btn btn-primary" href="add_dokter.php">+ Add Dokter</a><br/><br/>
                            <div id="tabel">
                            <table class="table table-stripped">
                                ...
                                $query = " SELECT * FROM dokter ORDER BY dokterid";
                                ...
                                while($row = $result->fetch_object()){
                                    ...
                                    echo '<td><a class = "btn btn-warning btn-sm" href="edit_dokter.php?id='.$row->dokterid.'">Edit</a>&nbsp;&nbsp;
                                        <a class = "btn btn-danger btn-sm" href="delete_dokter.php?id='.$row->dokterid.'">Delete</a>
                                        </td>';
                                    echo '<tr>';
                                    $i++;
                                }
