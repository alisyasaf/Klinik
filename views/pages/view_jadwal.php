        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                    ...
                    <div class="card">
                        <div class="card-header bg-dark text-white">Data Jadwal Mingguan</div>
                        <div class="card-body">
                            <br>
                            <div class="row justify-content-end">
                                ...
                                <div class="col-1">
                                    <a class="btn btn-primary" onkeyup="search_jadwal()">Search</a><br/><br/>
                                </div>
                            </div>
                            <a class="btn btn-primary" href="add_jadwal.php">+ Add Jadwal</a><br/><br/>
                            <div id="tabel">
                            <table class="table table-stripped">
                                ...
                                $query = " SELECT * FROM jadwal ORDER BY idjadwal";
                                ...
                                while($row = $result->fetch_object()){
                                    ...
                                    echo '<td><a class = "btn btn-warning btn-sm" href="edit_jadwal.php?id='.$row->idjadwal.'">Edit</a>&nbsp;&nbsp;
                                        <a class = "btn btn-danger btn-sm" href="delete_jadwal.php?id='.$row->idjadwal.'">Delete</a>
                                        </td>';
                                    echo '<tr>';
                                    $i++;
                                }
